            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('/maquina') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Codigo</th><th>Longitud</th><th>Latitud</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                            ...
                            <div class="pagination-wrapper"> {!! $maquina->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
