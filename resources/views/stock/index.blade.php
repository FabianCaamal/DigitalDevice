                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Maquina Id</th><th>Producto</th><th>Cantidad</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($stock as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->maquina_id }}</td><td>{{ $item->producto }}</td><td>{{ $item->cantidad }}</td>
                                        <td>
                                            ...
                                            <a href="{{ url('/stock/' . $item->id . '/edit') }}" title="Edit Stock"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
